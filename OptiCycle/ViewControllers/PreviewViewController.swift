...
extension PreviewViewController: InferenceViewControllerDelegate {
...
extension PreviewViewController: CameraFeedManagerDelegate {
...
extension PreviewViewController {
  ...
  private func addPanGesture() {
    let panGesture = UIPanGestureRecognizer(target: self, action: #selector(PreviewViewController.didPan(panGesture:)))
